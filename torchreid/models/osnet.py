...
__all__ = [
    'osnet_x1_0', 'osnet_x0_75', 'osnet_x0_5', 'osnet_x0_25', 'osnet_ibn_x1_0', 'osnet_x0_25_endocv', 'osnet_dcn_x0_5_endocv', 'osnet_dcn_x0_25_endocv',
]
...
def osnet_dcn_x0_25_endocv(num_classes=1000, pretrained=True, loss='softmax', freeze_backbone=False, **kwargs):
    model = OSNetWithDCN(
        num_classes,
        blocks=[OSBlock, OSBlock, OSBlock],
        layers=[2, 2, 2],
